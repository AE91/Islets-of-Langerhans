...
For at initialisere Arduinoen og hardwaren implementeres en funktion, som opsætter Arduinoen med de inputs og outputs der er specificeret under hardware afsnittet. \fxnote{Indsæt reference til IBD for Hardware}. Denne funktion er kaldt initArduino. Når brugeren klikker "Stop" skal systemet lukke ned som specificeret i Use Case 3. \fxnote{Reference til Use case 3} Til dette implementeres en funktion kaldet stopArduino. 
